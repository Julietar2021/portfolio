...
var typed = new Typed (".typing", {
  ...
  strings: ["Data Analyst, continuously learning and possessing extensive knowledge of SQL, Power BI, Excel, Tableau,Access Database, IBM Cognos Analytics, Google Data Studio, Big Query, Python, AWS QuickSight,Technical Support, Customer Support, Networking, System Troubleshooting, HTML, and CSS."],
  typeSpeed: 100,
  backSpeed: 60,
  loop: true
